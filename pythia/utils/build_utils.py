...
def build_trainer(args, *rest, **kwargs):
    ...
    configuration.config['model_attributes'][configuration.config['model']]['pretrain']= args.pretrain
    configuration.config['dataset_attributes'][configuration.config['datasets']]['pretrain']= args.pretrain
